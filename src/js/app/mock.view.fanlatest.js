define(function(require, exports, module) {
  ...
  $.widget('mock.fanlatest', _view, {
    ...
    _createElem: function() {
      ...
      h.push('<li class="tab-nav-item tab-nav-item-selected"><a href="#fans/latest">新增粉丝</a></li>');
      h.push('<li class="tab-nav-item"><a href="#fans/all">全部粉丝</a></li>');
      h.push('</ul>');
