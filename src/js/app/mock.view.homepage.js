define(function(require, exports, module) {
    ...
    $.widget('mock.homepage', _view, {
        ...
        _createWrapperElem: function() {
            ...
            h.push('<tr><td>头像</td><td style="position:relative;"><div class="hp-avatar"><img src="' + imgBase64Url + '?t=' + Date.now() + '"></div><a href="http://passport.baidu.com/center" style="position: absolute;bottom: 3px;display: inline-block;margin-left: 10px;">修改</a></td></tr>');
            h.push('<tr><td>名称</td><td>' + currentUserName + '<a href="http://passport.baidu.com/center" style="margin-left: 10px;">修改</a></td></tr>');
