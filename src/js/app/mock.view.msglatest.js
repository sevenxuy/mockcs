define(function(require, exports, module) {
  ...
  $.widget('mock.msglatest', _view, {
    ...
    _createElem: function() {
      ...
      h.push('<li class="tab-nav-item tab-nav-item-selected"><a href="#msgs/latest">最新消息</a></li>');
      h.push('<li class="tab-nav-item"><a href="#msgs/all">全部消息</a></li>');
      h.push('</ul>');
