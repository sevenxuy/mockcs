define(["mock.util", "mock.view.titleB.mainContentWithTitlePageContent"], function(util, PageContent) {
  'use strict';
  ...
  $.widget('mock.mockme', _view, {
    ...
    _createElem: function() {
      ...
      /*'<div class="mock-hd">快速吐槽</div>'+
      '<div class="page-content">'+
      '<ul class="tabs-nav">'+
      '<li class="tab-nav-item tab-nav-item-selected"><a href="#mocks/me">我</a></li>'+
      '<li class="tab-nav-item"><a href="#mocks/square">吐槽广场</a></li>'+
      '</ul>'+
      '<div class="tabs-content">'+
      '<div class="mock-search-box"><input type="search" placeholder="按关键词搜索" class="form-control mock-search"><div class="mock-search-icon"></div></div>'+
      '<table class="table table-bordered table-hover">'+
      '<thead><tr><th>内容标题</th><th>上线时间</th><th>吐槽数</th><th>点击数</th><th>参与人数</th><th>操作</th></tr></thead>'+
      '<tbody>'+
      '<tr><td>This is a test</td><td>2015-06-06 18:00</td><td>100</td><td>1000</td><td>50</td><td><div class="mock-btn mock-btn-red  mock-btn-s">展开</div></td></tr>'+
      '</tbody>'+
      '</table>'+
      '<div>是否分页？</div>'+
      '<div class="mock-search-box"><input type="search" placeholder="按关键词搜索" class="form-control mock-search"><div class="mock-search-icon"></div></div>'+
      '<div class="mock-btn mock-btn-red mock-add" data-toggle="modal" data-target="#mockme-modal">+ 新增</div>'+
      '<div class="modal fade" id="mockme-modal" tabindex="-1" role="dialog" aria-hidden="true">'+
      '<div class="modal-dialog">'+
      '<div class="modal-content">'+
      '<div class="modal-header">'+
      '<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>'+
      '<h4 class="modal-title" id="myModalLabel">//据操作确定</h4>'+
      '</div>'+
      '<div class="modal-body">'+
      '<textarea placeholder="回复吐槽" class="form-control"></textarea>'+
      '<div class="checkbox"><label><input type="checkbox"> 匿名发表</label></div>'+
      '</div>'+
      ...
      '</div>'+
      '<table class="table table-bordered table-hover">'+
      '<thead><tr><th>用户</th><th>点赞数</th><th>回复内容</th><th>上线时间</th><th>操作</th></tr></thead>'+
      '<tbody>'+
      '<tr><td>Anglina</td><td>2000</td><td>You are really an anglel.</td><td>2015-06-06 18:00</td><td><div class="mock-btn mock-btn-red  mock-btn-s">回复</div></td></tr>'+
      '</tbody>'+
      '</table>'+
      '<div>是否分页？</div>'+
      '</div>'+
