define(function(require, exports, module) {
  ...
  $.widget('mock.mocksquare', _view, {
    ...
    _createElem: function() {
      ...
      h.push('<li class="tab-nav-item"><a href="#mocks/me">我</a></li>');
      h.push('<li class="tab-nav-item tab-nav-item-selected"><a href="#mocks/square">吐槽广场</a></li>');
      h.push('</ul>');
      ...
      h.push('<div class="mock-search-box"><input type="search" placeholder="按关键词搜索" class="form-control mock-search"><div class="mock-search-icon"></div></div>');
      h.push('<div class="mock-btn mock-btn-red mock-add" data-toggle="modal" data-target="#mocksquare-modal">+ 新增</div>');
      h.push('<div class="modal fade" id="mocksquare-modal" tabindex="-1" role="dialog" aria-hidden="true">');
  ...
  module.exports = $.mock.mocksquare;
});
